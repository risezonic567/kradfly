        ...
        <>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <div className='max-w-5xl py-10 rounded-3xl bg-gray-100 p-5 mx-auto'>
                    <h2 className='text-lg sm:text-xl font-bold mt-5 mb-5'>🎰 Discover Las Vegas with Krad Fly</h2>
                    <p className='text-gray-500 mb-5 text-sm sm:text-base leading-relaxed'>
                        Experience the thrill of Las Vegas — the Entertainment Capital of the World! Whether you're visiting for dazzling shows, high-stakes casinos, or legendary nightlife, Krad Fly makes it easy to get there and explore with top-rated flight deals and convenient car rental options.
                    </p>
                    <hr />
                    ...
                    <ul className='text-gray-500 list-disc pl-5 sm:pl-10'>
                        ...
                        <li><b>Last-Minute Deals:</b> Need a quick escape? Krad Fly offers spontaneous travel savings to Las Vegas.</li>
                    </ul>
                    ...
                    <p className='font-semibold text-gray-500 mt-5 mb-5 text-sm sm:text-base'>
                       Start your Las Vegas journey with Krad Fly — book your flight and car rental today for big savings and unforgettable memories!
                    </p>
                 </div>
